...
class OVEApp(Enum):
    ...
    def from_data_type(cls, data_type: DataType):
        if data_type == DataType.HTML or data_type == DataType.DATAFRAME or data_type == DataType.LATEX or data_type == DataType.MARKDOWN or data_type == DataType.JSON or data_type == DataType.WIDGET:
            return cls.HTML
